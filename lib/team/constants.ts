...
import type { FirmMemberRole, Specialization, UserRole } from "@prisma/client";
...
// Map a firm designation → platform UserRole. "Admin" firm members
// run the full firm portal (CA_FIRM_ADMIN); everyone else operates
// as a CA within the firm.
export function firmRoleToUserRole(role: FirmMemberRole): UserRole {
  return role === "ADMIN" ? "CA_FIRM_ADMIN" : "CA";
}
