// ============================================================
// POST /api/banking/payments/[id]/submit — Maker submits a DRAFT
// payment for checker approval.
// ============================================================

import { NextResponse } from "next/server";
import { requireTenant, ForbiddenError, UnauthorizedError } from "@/lib/auth/require-tenant";
import { submitForApproval } from "@/lib/tbx/payments/payment.service";
...
export async function POST(_req: Request, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    const payment = await submitForApproval(organizationId, id, { userId, role });
    ...
    console.error("[POST /api/banking/payments/[id]/submit]", err);
