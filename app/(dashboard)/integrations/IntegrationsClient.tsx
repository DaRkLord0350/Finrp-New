...
export default function IntegrationsPage({ initialConnected = [] }: { initialConnected?: ConnectedIntegration[] }) {
  const [search, setSearch] = useState("");
  const [category, setCategory] = useState("All");
  const [statusFilter, setStatusFilter] = useState("All");
  const [connected] = useState<ConnectedIntegration[]>(initialConnected);
